	...
	function dang_tin () {
		...
		if (isset($_POST['dang_tin'])) {
			...
			if ($result) {
				...
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một dự án.\');window.location.href="/danh-sach-du-an"</script>';
			} else {
...
<div class="container">
	<div class="row">
		<h1 style="text-align: center;font-size: 30px;">Đăng dự án mới</h1>
		<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="email" placeholder="" name="service_name" required="">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <textarea class="form-control ckeditor1" rows="5" id="comment" name="service_des"></textarea>
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <textarea class="form-control ckeditor" rows="5" id="comment" name="service_content"></textarea>
		    </div>
		  </div>
		  <div class="form-group">
		    <label class="control-label col-sm-2" for="pwd">Địa chỉ:</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="pwd" placeholder="" name="service_author">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-2 col-sm-10">
		      <button type="submit" name="dang_tin" class="btn btn-default">Đăng dự án</button>
		    </div>
		  </div>
		</form>
	</div>
