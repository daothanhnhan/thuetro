...
foreach ($productcat_arr as $procat) { 
    ...
    $products = $action_product->getProductList_byMultiLevel_orderProductId_home($procat,'desc',$trang_2,'6', 'home', 'home');//var_dump($products);
...
<section class="featured-properties-area section-padding-100-50 home-product">
        <div class="container1">
            ...
            <div class="home-title" style="background: #c4000f;">
                <p class="text">BẤT ĐỘNG SẢN BÁN NỔI BẬT</p>
            </div>
