                        ...
                        <form id="advanceSearch" method="get" action="/index.php">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 text-right">
                                    <a href="" title="" style="font-weight: bold;color: #fff;background: #114fe5;padding: 10px;">Tìm kiếm nâng cao</a>
                                </div>
                                <div class="col-xs-12 text-right">
                ...
                <div class="col-xs-6 home-top-news">
                    <div class="row m-3">
                        ...
                        <div class="col-xs-4 p-3">
                            <a href="/<?= $home_top_news[0]['friendly_url'] ?>" title="" class="aspect-box">
                                <img src="/images/<?= $home_top_news[0]['news_img'] ?>" alt="tin tức" class="w100 aspect-img">
                            </a>
                        </div>
                        <div class="col-xs-8 p-3">
                            <a href="/<?= $home_top_news[0]['friendly_url'] ?>" title=""><?= $home_top_news[0]['news_name'] ?></a>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <img src="/images/banner-home-1.jpg" style="width: 100%;margin-top: 5px">
                        </div>
