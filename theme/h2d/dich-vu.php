...
<?php 
	...
	// $duan = $action->getList('service','','','service_id','desc',$trang,15,$_GET['page'], $_GET['page']);

	$duan = $action->getList_New('service', array(), array(), array('vip', 'service_id'), array('desc', 'desc'), '', $trang,15,$_GET['page'], $_GET['page']);
?>
<style>
