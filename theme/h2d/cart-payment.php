                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <form action="" method="POST" role="form" id="formPayment">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="txtName" id="inputTxtName" placeholder="Nhập Họ Tên" value="<?= $cart_name ?>" required="required">
                            </div>
                            <div class="form-group">
                                <label for="">Email</label>
                                <input type="email" class="form-control" name="txtEmail" id="inputTxtEmail" placeholder="Nhập Email" value="<?= $cart_email ?>" required="required">
                            </div>
                            <div class="form-group">
                                <label for="">Điện thoại <span style="color:#C03;">(*)</span></label>
                                <input type="tel" class="form-control" name="txtPhone" id="inputTxtPhone" placeholder="Nhập Số Điện Thoại" value="<?= $cart_phone ?>" required="required">
                            </div>
                            <div class="form-group">
                                <label for="">Địa chỉ <span style="color:#C03;">(*)</span></label>
                                <input type="text" class="form-control" name="txtAddress" id="inputTxtAddress" placeholder="Nhập Địa Chỉ Nhận Hàng" value="<?= $cart_address ?>" required="required">
                            </div>
                            <div class="form-group">
