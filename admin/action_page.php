...
class action_page extends library{
	...
	/*--------------- Sản phẩm --------------------*/
		...
		public function addProduct(){
			...
			$huyen_id = isset($_POST['huyen_id']) ? $_POST['huyen_id'] : '0';

			$phuong_id = isset($_POST['phuong_id']) ? $_POST['phuong_id'] : '0';


			$address = isset($_POST['address']) ? $_POST['address'] : '';
			$map = isset($_POST['map']) ? $_POST['map'] : '';
			$da_ban = isset($_POST['da_ban']) ? $_POST['da_ban'] : '0';
			$su_uu_tien = isset($_POST['su_uu_tien']) ? $_POST['su_uu_tien'] : '0';
			$phan_loai = isset($_POST['phan_loai']) ? $_POST['phan_loai'] : '0';
			$rent_time = isset($_POST['rent_time']) ? $_POST['rent_time'] : '0';
			$use_met = isset($_POST['use_met']) ? $_POST['use_met'] : '0';
			$chu_so_huu = isset($_POST['chu_so_huu']) ? $_POST['chu_so_huu'] : '';
			$tag = isset($_POST['tag']) ? $_POST['tag'] : '';
			$is_house = isset($_POST['is_house']) ? $_POST['is_house'] : '0';
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiisssssssssssssssssiiissiiiiissiissssii');
...
// echo json_encode(array('error'=>'Lỗi, mời thử lại tuan'));die;
...
/*---------------- Danh mục dịch vụ --------------------*/
	...
	/*------------------ dịch vụ -------------------*/
		...
		public function addService(){
			...
			$loai_du_an_id = isset($_POST['loai_du_an_id']) ? $_POST['loai_du_an_id'] : '0';
			$city_id = isset($_POST['city_id']) ? $_POST['city_id'] : '0';
			$district_id = isset($_POST['district_id']) ? $_POST['district_id'] : '0';
			$ward_id = isset($_POST['ward_id']) ? $_POST['ward_id'] : '0';
