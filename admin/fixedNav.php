...
<div class="fixedLeft">
 ...
 <!--           <li><a href="index.php?page=danh-muc-dich-vu" title=""
          ...
          <!--   <li><a href="index.php?page=don-hang" title=""
            ...
            <!-- <li><a href="index.php?page=y-kien" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Cảm nhận</a>
            </li>

            <li><a href="index.php?page=gui-yeu-cau" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Gửi yêu cầu</a>
            </li> -->
            ...
            <li><a href="index.php?page=huyen" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Huyện</a>
            </li>
            ...
            <li><a href="index.php?page=thong-bao" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Thông báo</a>
            </li>

            <li><a href="index.php?page=lich-su-giao-dich" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Lịch sử giao dịch</a>
            </li>
            <?php } ?>
...
<div class="logoTop">
    <a href="/" class="linkLogoTop"><img src="image/logoTop.png" class="imgLogoTop" style="width: 50%;" /></a>
