...
<form action="" method="post" accept-charset="utf-8" id="updatePage">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Nội dung 2</p>
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor" id="editor2" name="page_sub_info1" ><?= $row_showMain['lang_page_sub_info1'];?></textarea></p>
