<?php 
    ...
    if (!empty($row['city_id'])) {
        $district = $action->getList('district', 'city_id', $row['city_id'], 'id', 'asc', '', '', '');
    }
    if (!empty($row['district_id'])) {
        $ward = $action->getList('ward', 'district_id', $row['district_id'], 'id', 'asc', '', '', '');
    }
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <select name="district_id" class="txtNCP1" onchange="chon_district(this.value)" id="district_id">
                        ...
                        <option value="<?= $item['id'] ?>" <?= $item['id']==$row['district_id'] ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="subColContent">
                    ...
                    <select name="ward_id" class="txtNCP1" id="ward_id">
                        ...
                        <option value="<?= $item['id'] ?>" <?= $item['id']==$row['ward_id'] ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
