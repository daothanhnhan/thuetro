<?php 
	...
	function thuoc_tinh ($id) {
		...
		if (isset($_POST['add_attribute'])) {
			...
			$sql = "UPDATE product_diff_color SET name = '$name' WHERE id = $id";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã sửa được một nhóm sản phẩm.\')</script>';
			} else {
	...
	$info = $action->getDetail('product_diff_color', 'id', $_GET['id']);
?>
