<?php 
	...
	function phuong ($id) {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "UPDATE phuong SET name = '$name', huyen_id = $huyen_id WHERE id = $id";
	...
	$info = $action->getDetail('phuong', 'id', $_GET['id']);
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <select name="huyen_id" class="txtNCP1">
            	...
            	<option value="<?= $item['id'] ?>" <?= $item['id']==$info['huyen_id'] ? 'selected' : '' ?> ><?= $item['name'] ?></option>
            	<?php } ?>
            </select>
